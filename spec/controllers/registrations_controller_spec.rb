...
describe Competitive::RegistrationsController do
  ...
  #       post :create, {:registration => valid_attributes}, valid_session
  #       response.should redirect_to([:competitive, Registration.last])
  #     end
  #   end
  ...
  #       post :create, {:registration => { "registerable_id" => "invalid value" }}, valid_session
  #       assigns(:registration).should be_a_new(Registration)
  #     end
  ...
  #       Registration.any_instance.should_receive(:update_attributes).with({ "registerable_id" => "1" })
  #       put :update, {:id => registration.to_param, :registration => { "registerable_id" => "1" }}, valid_session
  #     end
  ...
  #       registration = Registration.create! valid_attributes
  #       put :update, {:id => registration.to_param, :registration => valid_attributes}, valid_session
  #       response.should redirect_to([:competitive, registration])
  #     end
  #   end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Registration.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => registration.to_param, :registration => { "registerable_id" => "invalid value" }}, valid_session
  #       assigns(:registration).should eq(registration)
  #     end
  ...
  #     registration = Registration.create! valid_attributes
  #     delete :destroy, {:id => registration.to_param}, valid_session
  #     response.should redirect_to(competitive_registrations_url)
  #   end
  # end
