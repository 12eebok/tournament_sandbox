...
describe MatchesController do
  ...
  #       post :create, {:match => { "competition_id" => "invalid value" }}, valid_session
  #       assigns(:match).should be_a_new(Match)
  #     end
  ...
  #       Match.any_instance.should_receive(:update_attributes).with({ "competition_id" => "1" })
  #       put :update, {:id => match.to_param, :match => { "competition_id" => "1" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Match.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => match.to_param, :match => { "competition_id" => "invalid value" }}, valid_session
  #       assigns(:match).should eq(match)
  #     end
