...
describe CompetitionsController do
  ...
  #   { "starts_at" => "2013-04-22 12:11:14", "game_id" => 1}
  # end
  ...
  #       post :create, {:competition => { "starts_at" => "invalid value" }}, valid_session
  #       assigns(:competition).should be_a_new(Competition)
  #     end
  ...
  #       Competition.any_instance.should_receive(:update_attributes).with({ "starts_at" => "2013-04-22 12:11:14" })
  #       put :update, {:id => competition.to_param, :competition => { "starts_at" => "2013-04-22 12:11:14" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Competition.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => competition.to_param, :competition => { "starts_at" => "invalid value" }}, valid_session
  #       assigns(:competition).should eq(competition)
  #     end
